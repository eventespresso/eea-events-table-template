...
/*
  ...
  Shortcode Parameters: footable = false (disables FooTable), table_search = false (turn off search), table_filter = false (turn off the table filter), table_style = standalone (alternate styles: metro), table_sort = false (disables FooTable sorting), table_striping = false (turn off striping), table_paging = false (hide paging), table_pages = 10, limit = 10, show_expired = FALSE, month = NULL, category_slug = NULL, category_filter = false, order_by = start_date, sort = ASC, template_file = espresso-events-table-template.template.php (upload custom templates to wp-content/uploads/espresso/templates/)
